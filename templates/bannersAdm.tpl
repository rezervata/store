...
{section name=si loop=$NODE}
	<img src="/img/t{$NODE[si].image}.jpg" style="float:left; width:60px; height:auto; border:#fff 2px solid; margin:8px; box-shadow:0 0 5px #888;" alt="{$NODE[si].name|stripslashes} - {$NODE[si].price}" title="{$NODE[si].name|stripslashes} - {$NODE[si].price}">
